...
const features = [
  ...
  {
    title: "Communauté",
    description: "Rejoins d'autres artistes indépendants de l'animation 2D et 3D.",
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2">
...
export default async function DevenirArtistePage() {
  ...
  return (
    <InfoPage
      ...
      subtitle="ZorAnim est construit pour et par les artistes indépendants de l'animation 2D et 3D."
    >
